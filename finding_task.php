					...
					<div class="col-md-9  col2-style">
                        <div class="panel panel-primary panel-style">
						  ...
						  <div class="panel-body panel-body-style">
								<div class="row">
									<div class="col-md-12">
										<form method="POST" action="finding_task.php?id=<?php echo $uid;?>" class="form-horizontal" role="form">
										
											<div class="form-group has-feedback has-feedback-right">
												<label class="control-label col-md-3" for="sdate">Start Date:</label>
												<div class="col-md-5"> 
													<input type="text" class="form-control sdate-time"id="datetimepicker" name="sdate" placeholder="Your Task Start Date">
											...
											<div class="form-group has-feedback has-feedback-right">
												...
												<div class="col-md-5"> 
													<input type="text" class="form-control edate-time"id="datetimepicker" name="edate" placeholder="Your Task End Date">
													<i class="form-control-feedback glyphicon glyphicon-calendar"></i>
												</div>
											</div>
											<div class="form-group has-feedback has-feedback-right"> 
											...
											if ($_SERVER["REQUEST_METHOD"] == "POST")	
											  {
												...
												if(isset($_POST['submit']))
												{
			                                        ...
			                                        {
														$sql = "SELECT task_title,task_description,date,task_status FROM to_do_lists WHERE user_id='$uid' AND date >= '$start_date' AND date < '$end_date'";
